...
def get_args_parser():
    ...
    # config file
    parser.add_argument('--cfg',help='experiment configure file name',type=str, default='/home/ajesh/Projects/DL-lab/Main-Project/AutoFormer/AutoFormer/experiments_configs/supernet-swinir/supernet-T.yaml')

    parser.add_argument('--opt-doc', type=str, default='/home/ajesh/Projects/DL-lab/Main-Project/AutoFormer/AutoFormer/experiments_configs/train_swinir_sr_lightweight.json', help='Path to option JSON file for SwinIR.')
    # custom parameters
