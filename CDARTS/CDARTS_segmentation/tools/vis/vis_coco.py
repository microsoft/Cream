...
json_file = './panoptic_coco_mul2/panoptic/predictions.json'
segmentations_folder = './panoptic_coco_mul2/panoptic/predictions/'
img_folder = '/home2/hongyuan/data/coco2017/val2017/'
panoptic_coco_categories = './panoptic_coco_categories.json'
output_dir = 'coco_vis_results'
